  ...
  return (
   <section className="rounded-lg p-4 h-screen lg:h-auto lg:min-h-[600px]">
    ...
    <div className="lg:grid lg:grid-cols-3 lg:gap-6 lg:max-w-5xl lg:mx-auto">
        ...
        >
            <p className="text-headline text-white uppercase text-center pt-10 pb-10 lg:pt-8 lg:pb-8">Upcoming Phase</p>
        </button>
        <button 
        ...
        >
            <p className="text-headline text-foreground text-center pt-10 pb-10 lg:pt-8 lg:pb-8">{selectedArticles[0]?.title || "Article"}</p>
        </button>
        <button 
        ...
        >
            <p className="text-headline text-foreground text-center pt-10 pb-10 lg:pt-8 lg:pb-8">{selectedArticles[1]?.title || "Article"}</p>
        </button>
    </div>
    ...
    {isPhaseModalOpen && nextPhase && (
      ...
      >
        <div 
          className="bg-white/55 backdrop-blur-xl rounded-2xl p-8 lg:p-12 max-w-md lg:max-w-4xl w-full relative shadow-2xl shadow-black/10 border border-white/50"
        ...
        >
          ...
          <div className="mt-4">
            <h3 
              className="text-headline text-center mb-4"
            ...
            <div className="space-y-4">
              <div>
                <h4 className="text-headline text-foreground mb-2">
                  What to expect:
                </h4>
                <p className="text-body text-foreground">
    ...
    {isArticle1ModalOpen && selectedArticles[0] && (
      ...
      >
        <div 
          className="bg-white/55 backdrop-blur-xl rounded-2xl p-8 lg:p-12 max-w-md lg:max-w-3xl w-full relative shadow-2xl shadow-black/10 border border-white/50 border-t-[3px] border-t-secondary"
          onClick={(e) => e.stopPropagation()}
        >
          {/* Close button */}
          <button
          ...
          <div className="mt-4">
            <h3 
              className="text-headline text-center mb-6"
              style={{ color: "#5941F2" }}
            >
    ...
    {isArticle2ModalOpen && selectedArticles[1] && (
      ...
      >
        <div 
          className="bg-white/55 backdrop-blur-xl rounded-2xl p-8 lg:p-12 max-w-md lg:max-w-3xl w-full relative shadow-2xl shadow-black/10 border border-white/50 border-t-[3px] border-t-alert"
          onClick={(e) => e.stopPropagation()}
        >
          {/* Close button */}
          <button
